...
Das ist der fundamentale Mismatch: **Du zahlst deterministische Kosten fÃ¼r stochastische Ergebnisse.** Jeder API-Call kostet Geld. Ob das Ergebnis brauchbar ist, weisst Du vorher nicht.

### Zwei Arten von Unsicherheit

- **Epistemisch** (Wissensluecke): Kann mit mehr Daten reduziert werden. Beispiel: Dein Modell kennt Dein Produktsortiment nicht → LÃ¶sung: RAG mit Produktdatenbank.
...
**PM-Implikation:** Verschwende kein Budget darauf, irreduzible Unsicherheit zu eliminieren. Investiere stattdessen in Systeme, die damit umgehen kÃ¶nnen.
...
Eine Eskalationsrate von ~60% ist ein klares Signal fÃ¼r Fehlkalibrierung.

## Scenario

Du baust ein AI-gestuetztes Triage-System fÃ¼r eine Versicherung. Eingehende Schadensmeldungen sollen automatisch kategorisiert und priorisiert werden.
...
**Warum:**
- 71% bei "Komplex" ist zu niedrig fÃ¼r irreversible Entscheidungen mit 2.400 EUR Fehlerkosten
- "Einfach" bei 92% ist vertretbar — Glasbruch falsch kategorisiert verursacht Verzoegerung, keinen Schaden
- Der 88%-Schwellenwert fÃ¼r "Mittel" funkt als Sicherheitsnetz: unsichere Faelle gehen an Menschen
