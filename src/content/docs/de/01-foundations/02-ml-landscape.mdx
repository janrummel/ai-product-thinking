...
Ein Neural Network hat Input-Layer, Hidden Layers und Output-Layer. "Deep" bedeutet: viele Hidden Layers. Jede Verbindung hat ein Gewicht (Weight), das beim Training gelernt wird. GPT-4 hat geschaetzt ~1,8 Billionen solcher Parameter.
