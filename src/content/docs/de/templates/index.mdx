---
title: "Templates"
description: "Fuenf Arbeitsvorlagen fuer AI Product Management — direkt einsetzbar."
sidebar:
  order: 1
---
...
- Launch-Kriterien: [Eval Metrics ueber Schwellenwert + Human Review bestanden]
...
AI-Readiness (1-5):
  ...
  4: Eval-Daten vorhanden, Prototyp moeglich
...
PRIORITAETS-MATRIX
| Kategorie | Prioritaet | Testfaelle | Status |
|-----------|-----------|------------|--------|
...
[ ] Alle Kern-Metriken ueber Minimum-Schwellenwert
...
[ ] Rollback in <1h moeglich
[ ] Rollback-Trigger definiert (bei welchen Werten?)

MONITORING
[ ] Real-Time Monitoring fuer Kern-Metriken eingerichtet
[ ] Alerting konfiguriert (Schwellenwerte + Empfaenger)
[ ] Feedback-Loop fuer User-Reports vorhanden
...
Basierend auf Kapitel 9: KPIs fuer AI-Produkte.
...
--- QUALITY METRICS (Technische Qualitaet) ---
...
- Korreliert sie mit Churn? → Falls ja: Qualitaet direkt umsatzrelevant
