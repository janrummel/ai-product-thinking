...
Ein anderer Fall: Air Canadas AI-Chatbot erfindet eine Erstattungsrichtlinie fuer Trauerfaelle, die es nie gab. Ein Tribunal entscheidet: Die Airline haftet fuer die halluzinierte Policy.

Google Bards Launch-Demo 2023 enthaelt einen Faktenfehler ueber das James Webb Telescope. Die Folge: rund 100 Milliarden Dollar Rueckgang bei Alphabets Marktkapitalisierung an einem Tag — wobei auch andere Marktfaktoren eine Rolle spielten.

Hallucinations sind kein theoretisches Problem. Sie haben reale, messbare Konsequenzen — finanziell, rechtlich und fuer das Vertrauen Deiner User.

## Concept

### Warum Hallucinations strukturell sind

LLM-Hallucinations sind keine Software-Bugs, die man fixt. Sie sind eine strukturelle Eigenschaft der Architektur. LLMs generieren Text, indem sie das wahrscheinlichste naechste Token vorhersagen — basierend auf statistischen Mustern. Das bedeutet:
...
**RAG (Retrieval-Augmented Generation)** verankert Antworten in externen Dokumenten. Allgemeine Benchmarks zeigen Reduktionen von 40-71%. Aber: Fuer spezialisierte Domaenen ist das Bild anders — eine Stanford-Studie zu Legal RAG zeigt, dass Hallucinations "substanziell, vielfaeltig und potenziell heimtueckisch bleiben", auch mit RAG. Die Reduktionsrate haengt stark von Retrieval-Qualitaet und Domaene ab.

**Span-Level Verification** prueft jede einzelne Behauptung gegen Evidenz aus abgerufenen Quellen. Geht ueber dokument-basiertes RAG hinaus zu satzbasiertem Grounding.
...
**Human-in-the-Loop** ist fuer Hochrisiko-Domaenen (Gesundheit, Recht, Finanzen) unverzichtbar. Skaliert schlecht, ist aber in manchen Kontexten die einzige verantwortbare Option.

### UX-Patterns fuer halluzinationsanfaellige Outputs
...
Du bist PM eines AI-Rechtsassistenten fuer eine mittelgrosse Kanzlei. Der Assistent soll Anwaelte bei der Recherche unterstuetzen — relevante Urteile finden, Zusammenfassungen erstellen, Argumentationslinien vorschlagen.
...
- Ein Partner der Kanzlei will das Tool sofort fuer Client-facing Schriftsaetze freigeben
...
**Die beste Entscheidung:** Weder sofort freigeben noch abschalten. Das Tool als Recherche-Unterstuetzung behalten, aber mit striktem Human-in-the-Loop: Jede Quelle muss vom Anwalt verifiziert werden, bevor sie in einen Schriftsatz einfliesst. Parallel die Hallucination Rate durch Span-Level Verification und bessere Retrieval-Qualitaet senken.

**Warum:**
- 6% Hallucination Rate bei Quellenangaben ist fuer ein Legal-Tool zu hoch fuer unueberwachte Nutzung — der Anwalt-Sanktionierungs-Fall zeigt die Konsequenzen
...
- Das Air-Canada-Urteil zeigt: Dein Unternehmen haftet fuer halluzinierte Outputs — nicht das Modell, nicht der Anbieter
...
- RAG reduziert Hallucinations um 40-71% — das bedeutet, 29-60% bleiben. Es ist eine Mitigation, keine Loesung
...
- Die Verbesserung von Hallucination Rates ist logarithmisch — jede marginale Verbesserung wird schwieriger. Fuer Hochrisiko-Domaenen ist die aktuelle Rate unakzeptabel, unabhaengig vom Trend
