...
Ein anderer Fall: Air Canadas AI-Chatbot erfindet eine Erstattungsrichtlinie fÃ¼r Trauerfaelle, die es nie gab. Ein Tribunal entscheidet: Die Airline haftet fÃ¼r die halluzinierte Policy.

Google Bards Launch-Demo 2023 enthaelt einen Faktenfehler Ã¼ber das James Webb Telescope. Die Folge: rund 100 Milliarden Dollar Rueckgang bei Alphabets Marktkapitalisierung an einem Tag — wobei auch andere Marktfaktoren eine Rolle spielten.

Hallucinations sind kein theoretisches Problem. Sie haben reale, messbare Konsequenzen — finanziell, rechtlich und fÃ¼r das Vertrauen Deiner User.

## Concept

### Warum Hallucinations strukturell sind

LLM-Hallucinations sind keine Software-Bugs, die man fixt. Sie sind eine strukturelle Eigenschaft der Architektur. LLMs generieren Text, indem sie das wahrscheinlichste nÃ¤chste Token vorhersagen — basierend auf statistischen Mustern. Das bedeutet:
...
**RAG (Retrieval-Augmented Generation)** verankert Antworten in externen Dokumenten. Allgemeine Benchmarks zeigen Reduktionen von 40-71%. Aber: FÃ¼r spezialisierte Domaenen ist das Bild anders — eine Stanford-Studie zu Legal RAG zeigt, dass Hallucinations "substanziell, vielfaeltig und potenziell heimtueckisch bleiben", auch mit RAG. Die Reduktionsrate haengt stark von Retrieval-QualitÃ¤t und Domaene ab.

**Span-Level Verification** prÃ¼ft jede einzelne Behauptung gegen Evidenz aus abgerufenen Quellen. Geht Ã¼ber dokument-basiertes RAG hinaus zu satzbasiertem Grounding.
...
**Human-in-the-Loop** ist fÃ¼r Hochrisiko-Domaenen (Gesundheit, Recht, Finanzen) unverzichtbar. Skaliert schlecht, ist aber in manchen Kontexten die einzige verantwortbare Option.

### UX-Patterns fÃ¼r halluzinationsanfaellige Outputs
...
Du bist PM eines AI-Rechtsassistenten fÃ¼r eine mittelgrosse Kanzlei. Der Assistent soll Anwaelte bei der Recherche unterstuetzen — relevante Urteile finden, Zusammenfassungen erstellen, Argumentationslinien vorschlagen.
...
- Ein Partner der Kanzlei will das Tool sofort fÃ¼r Client-facing Schriftsaetze freigeben
...
**Die beste Entscheidung:** Weder sofort freigeben noch abschalten. Das Tool als Recherche-Unterstuetzung behalten, aber mit striktem Human-in-the-Loop: Jede Quelle muss vom Anwalt verifiziert werden, bevor sie in einen Schriftsatz einfliesst. Parallel die Hallucination Rate durch Span-Level Verification und bessere Retrieval-QualitÃ¤t senken.

**Warum:**
- 6% Hallucination Rate bei Quellenangaben ist fÃ¼r ein Legal-Tool zu hoch fÃ¼r unueberwachte Nutzung — der Anwalt-Sanktionierungs-Fall zeigt die Konsequenzen
...
- Das Air-Canada-Urteil zeigt: Dein Unternehmen haftet fÃ¼r halluzinierte Outputs — nicht das Modell, nicht der Anbieter
...
**Hallucinations sind kein Bug, den Du fixst — sie sind ein Risiko, das Du managst.** Deine Aufgabe als PM ist nicht, sie zu eliminieren (das geht nicht), sondern Produkte zu bauen, die trotz Hallucinations verlÃ¤sslich sind.

- RAG reduziert Hallucinations um 40-71% — das bedeutet, 29-60% bleiben. Es ist eine Mitigation, keine LÃ¶sung
...
- Die Verbesserung von Hallucination Rates ist logarithmisch — jede marginale Verbesserung wird schwieriger. FÃ¼r Hochrisiko-Domaenen ist die aktuelle Rate unakzeptabel, unabhÃ¤ngig vom Trend
