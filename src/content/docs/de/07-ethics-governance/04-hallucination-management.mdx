...
**RAG (Retrieval-Augmented Generation)** reduziert Hallucinations um 40-71%, indem Antworten in externen Dokumenten verankert werden. Aber: Eine Stanford-Studie zu Legal RAG zeigt, dass Hallucinations "substanziell, vielfaeltig und potenziell heimtueckisch bleiben" — auch mit RAG.
