...
|------|--------|-------------|
| **[NVIDIA NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails)** | Open-Source Toolkit | Colang DSL für Rails-Definition; "Adopt"-Status im [ThoughtWorks Radar](https://www.thoughtworks.com/radar) |
| **[Guardrails AI](https://www.guardrailsai.com/)** | Open-Source Framework | Validator-basiert; 100+ fertige Validatoren |
...
*Quellen: [NVIDIA NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) Documentation, [Guardrails AI](https://www.guardrailsai.com/), [ThoughtWorks Technology Radar](https://www.thoughtworks.com/radar), Obsidian Security — AI Guardrails Analysis*
