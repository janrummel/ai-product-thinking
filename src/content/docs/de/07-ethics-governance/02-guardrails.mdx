---
title: "Guardrails"
description: "Wie Du AI-Systeme innerhalb akzeptabler Grenzen haeltst — ohne die Nuetzlichkeit zu zerstoeren."
sidebar:
  order: 2
---
...
Euer AI-Assistent fuer Kundenberater ist seit drei Wochen live. Dann passiert es: Ein Kunde fragt nach Informationen zu einem sensiblen medizinischen Thema, und der Assistent gibt detaillierte medizinische Ratschlaege — ohne Verweis auf einen Arzt.

Am naechsten Tag eskaliert ein anderer Fall: Ein Berater wollte eine voellig legitime Frage zu Versicherungsleistungen bei Schwangerschaft beantworten lassen, aber der Content-Filter blockiert alles, was "Schwangerschaft" enthaelt. Der Berater tippt die Antwort manuell — und nutzt den AI-Assistenten fuer dieses Thema nie wieder.
...
|------|--------|-------------|
| **NVIDIA NeMo Guardrails** | Open-Source Toolkit | Colang DSL fuer Rails-Definition; "Adopt"-Status im ThoughtWorks Radar |
...
- Erodiert Vertrauen ("Dieses Tool ist nutzlos fuer meine echte Arbeit")
...
Du bist PM eines AI-Schreibassistenten fuer Versicherungsberater. Der Assistent hilft beim Verfassen von Kundenbriefen. Nach dem Launch kommen folgende Daten rein:
...
- Die Loesung ist ein Layered Approach: Grober Filter fuer klar problematische Inhalte + kontextbezogener Filter fuer Fachbegriffe + User-Feedback-Loop fuer Edge Cases
...
- Mehr Guardrails bedeutet nicht automatisch mehr Sicherheit — Praezision schlaegt Aggressivitaet
