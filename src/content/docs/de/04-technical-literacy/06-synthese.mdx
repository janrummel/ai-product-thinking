...
description: "Wie die fuenf technischen Lektionen eine Optimierungshierarchie bilden — und warum die PM-Aufgabe nicht maximale Qualität ist, sondern die richtige Balance."
sidebar:
  order: 6
---
...
### 3. Qualität ist keine einzelne Zahl
...
|---------|-------------------|----------------|
| AI-Output-Qualität stimmt nicht | Prompt Engineering (L1) | Prompt verbessern |
...
Du kennst die Technologie. [Kapitel 5](../../05-evaluation/) zeigt, wie Du AI-Qualität misst und Ship/No-Ship-Entscheidungen triffst.
...
### Szenario 2: Frontier-Modell für alles
...
*Quellen: Aufbauend auf Lektionen 1-5. IBM RAG vs Fine-Tuning vs Prompt Engineering, [a16z LLMflation](https://a16z.com/llmflation-llm-inference-cost/), DAIR.AI Prompt Engineering Guide, Artificial Analysis LLM Leaderboard, Pinecone RAG Architecture Guide*
