...
description: "Warum der Prompt die Produktspezifikation Deines AI-Features ist — und wie Du mit der richtigen Technik QualitÃ¤t steuerst, ohne Code zu schreiben."
sidebar:
  order: 1
---
...
Dein AI-Feature liefert inkonsistente Ergebnisse. Mal ist die Zusammenfassung perfekt, mal voellig daneben. Das Engineering-Team schlÃ¤gt Fine-Tuning vor — drei Wochen Aufwand, 15.000 Euro Budget. Dein Tech Lead fragt: "Habt ihr den Prompt schon optimiert?"

Prompt Engineering ist der schnellste, guenstigste Hebel, um AI-Output-QualitÃ¤t zu verbessern. FÃ¼r PMs ist es mehr als ein technisches Detail: Der Prompt *ist* die Produktspezifikation. Er definiert Verhalten, Ton, Format und Grenzen Deines AI-Features. Wer den Prompt versteht, versteht das Produkt.
...
**Zero-Shot:** Nur die Aufgabe beschreiben, keine Beispiele. Funktioniert fÃ¼r gut verstandene Tasks wie Zusammenfassungen oder Uebersetzungen. Starte immer hier — minimale Tokens, schnellste Iteration.

**Few-Shot:** 1-5 Beispiele von gewuenschten Input-Output-Paaren mitgeben. Forschung zeigt starke Verbesserungen ab 1-2 Beispielen, mit abnehmenden Ertraegen ab 4-5. PM-Falle: 10+ Beispiele "zur Sicherheit" verschwenden Tokens und kÃ¶nnen das Modell verwirren.

**Chain-of-Thought (CoT):** Das Modell anweisen, Schritt fÃ¼r Schritt zu denken. Bringt laut der urspruenglichen Benchmark-Studie bis zu 19 Punkte Verbesserung bei komplexen Reasoning-Aufgaben (MMLU-Pro Benchmark). Aber Vorsicht: Bei Reasoning-Modellen (o-Serie, Claude Extended Thinking) ist explizites CoT redundant — sie machen es intern bereits.

**System Prompts:** Der unsichtbare Rahmen, der Rolle, Einschraenkungen und Verhalten definiert. System Prompts werden typischerweise gecacht (Anthropic berechnet 0,1x des Basispreises fÃ¼r gecachte Reads) — kosteneffizient bei wiederholter Nutzung.
...
**Self-Consistency:** Denselben Prompt mehrfach ausfÃ¼hren, Mehrheitsantwort nehmen. Erhoeht Genauigkeit bei 3-5x Kosten — nur fÃ¼r High-Stakes-Entscheidungen.
...
### Prompt Security — was PMs wissen mÃ¼ssen

Prompts sind keine geschuetzten Befehle — sie sind angreifbar. PMs mÃ¼ssen die wichtigsten Risiken kennen:
...
- **Data Exfiltration:** Das Modell gibt Informationen aus dem System Prompt oder Kontext preis, die nicht fÃ¼r den Nutzer bestimmt sind

**PM-Entscheidung:** Welche Aktionen darf das AI-Feature ausfÃ¼hren? Je mehr Autonomie (E-Mails senden, Daten Ã¤ndern), desto kritischer wird Prompt Security. Bei High-Stakes-Features gehÃ¶rt Security-Testing (Red Teaming, s. Kapitel 5) in den Launch-Prozess.
...
3. **"Ein perfekter Prompt funktioniert ewig."** Falsch. Model-Updates Ã¤ndern Verhalten. Prompts brauchen Versionierung und Monitoring wie jedes Feature.
...
| System Prompt (gecacht) | Erster Call: volle Kosten; danach: 0.1x | Keiner nach dem ersten | Immer fÃ¼r Product Features |
...
- Budget: 8.000 Euro fÃ¼r die erste Iteration
- Volumen: 25.000 Klauseln/Monat
- Zeitdruck: Feature-Launch in 4 Wochen
- Engineering-Team schlÃ¤gt Fine-Tuning vor (3 Wochen, 15.000 Euro)

**Optionen:**
1. **Fine-Tuning:** 3 Wochen Entwicklung, 15.000 Euro, 500+ gelabelte Beispiele noetig
2. **Few-Shot + CoT:** 3-5 Beispiele von Experten-Analysen als Vorlage, Schritt-fÃ¼r-Schritt-Reasoning erzwingen. 2-3 Tage Arbeit, unter 500 Euro Prompt-Kosten
...
- **Kosten-Risiko:** Fine-Tuning fÃ¼r 15.000 Euro bei einem Feature, das mit besserem Prompting mÃ¶glicherweise 90%+ erreicht, ist voreilig. Die Praxis-Erfahrung vieler Teams zeigt: Fine-Tuning eines schwachen Modells verliert oft gegen gutes Prompting eines starken Modells
...
- **Erwarteter Impact:** Praxis-Erfahrungswerte (nicht einzelne Studien) zeigen, dass Few-Shot + CoT zusammen 15-25 Prozentpunkte Verbesserung gegenueber Zero-Shot bringen kÃ¶nnen — variiert stark je nach Task
...
- **Der Prompt ist die Produktspezifikation.** Wer den Prompt nicht versteht, versteht nicht, was das AI-Feature tut. PMs mÃ¼ssen Prompt-Design besitzen — nicht delegieren.
- Starte immer bei Zero-Shot und eskaliere nur bei messbaren Fehlern. Jede Stufe kostet mehr Tokens und KomplexitÃ¤t.
