...
**Graph-basierte Orchestrierung** (z.B. via LangGraph) ist kein separates viertes Pattern, sondern eine Implementierungsmethode fuer die drei Patterns oben: Agents bilden einen gerichteten Graphen mit Bedingungen, Schleifen und dynamischem Routing.
