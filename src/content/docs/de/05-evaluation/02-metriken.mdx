...
Als PM musst Du nicht jede Formel verstehen. Aber Du musst wissen, welche Metrik fÃ¼r welchen Produkttyp relevant ist, was die Zahlen fÃ¼r User und Business bedeuten, und wann eine Zahl truegerisch gut aussieht. Die Metrik-Auswahl ist eine Produktentscheidung — nicht eine technische.
...
**Die Accuracy-Falle:** Accuracy ist bei unbalancierten Datensaetzen truegerisch. Ein Spam-Filter mit 99% Accuracy klingt grossartig — bis Du realisierst, dass 99% der E-Mails kein Spam sind. Das Modell kÃ¶nnte einfach alles als "kein Spam" labeln und 99% erreichen.

### Generation Metrics

FÃ¼r Produkte, die Text generieren (Zusammenfassungen, Uebersetzungen, Content):

| Metrik | StÃ¤rke | Limitation |
|--------|---------|-----------|
...
| LLM-as-Judge | Offene QualitÃ¤t, Ton, Hilfsbereitschaft | Kosten, Latenz, Judge Bias |

**Aktueller Konsens:** LLM-as-Judge hat sich als bevorzugte Metrik fÃ¼r finale Qualitaetsbewertung bei generativer AI etabliert. BLEU und ROUGE bleiben nuetzlich fÃ¼r schnelle Regressions-Checks in CI/CD-Pipelines.
...
| AUC = 0.94 | "Das Modell rankt einen positiven Fall Ã¼ber einen negativen in 94% der Faelle korrekt" |
...
| Search / Retrieval | NDCG (Normalized Discounted Cumulative Gain — Ranking-QualitÃ¤t), MRR (Mean Reciprocal Rank — Position des ersten relevanten Ergebnisses), Context Relevance | Retrieval-Latenz, Zero-Result-Rate |
...
**Regeln fÃ¼r Stakeholder-Kommunikation:**
...
2. Tradeoffs zeigen, nicht Einzelzahlen: "Wir kÃ¶nnen die Trefferquote von 85% auf 95% erhÃ¶hen, aber Fehlalarme verdreifachen sich"
...
**Die beste Entscheidung:** Modell A mit Human Review fÃ¼r nicht erfasste Faelle.
...
- **Modell A + Human Review:** Die 1.200 verpassten Fakes plus Borderline-Faelle einem Moderator zuweisen. Kosten: ca. 4.000 EUR/Monat fÃ¼r einen Teilzeit-Moderator.
...
- "Accuracy reicht als Metrik" — Bei 8% Fake Rate wÃ¼rde ein Modell, das alles als "echt" labelt, 92% Accuracy erreichen.
</details>

## Reflect

**Die Metrik-Auswahl ist eine Produktentscheidung, keine technische. Denn jede Metrik codiert einen Tradeoff — und der PM muss entscheiden, welchen Tradeoff die User akzeptieren kÃ¶nnen.**

- Precision vs. Recall ist kein technisches Detail — es ist die Frage, ob False Positives oder False Negatives fÃ¼r Dein Produkt schaedlicher sind.
