...
description: "Warum Evals die wichtigste Kompetenz fÃ¼r AI Product Manager sind — und wie Du Dein erstes Eval-System aufbaust."
sidebar:
  order: 1
---
...
Dein Team hat ein AI-Feature gelauncht: Ein Chatbot beantwortet Kundenfragen zu Euren Produkten. Nach zwei Wochen beschweren sich User Ã¼ber falsche Antworten. Der CTO fragt: "Wie schlecht ist es genau?" Niemand kann antworten, weil es keine systematische Evaluation gibt.

Traditionelles Software-Testing prÃ¼ft deterministisches Verhalten: Input X ergibt immer Output Y. AI-Systeme sind probabilistisch — derselbe Input kann bei jedem Durchlauf verschiedene Outputs erzeugen. Das macht klassische Unit Tests unzureichend. Evaluation ("Evals") ist die Disziplin, AI-Output-QualitÃ¤t systematisch zu messen, damit Teams mit Zuversicht iterieren kÃ¶nnen.
...
Der PM besitzt die Eval-Strategie, weil der PM definiert, was "gut" fÃ¼r den User bedeutet. Die Verantwortung verteilt sich so:

- **PM** definiert Qualitaetskriterien (was fÃ¼r User und Business zaehlt)
...
4. **Reasoning dokumentieren** — FÃ¼r jedes Label erklÃ¤rt der Experte kurz, warum der Output besteht oder durchfaellt.
...
LLM-as-Judge nutzt ein Sprachmodell, um die Outputs eines anderen Modells zu bewerten — Human Judgment im grossen MaÃstab. Die wichtigste Eval-Technik fÃ¼r generative AI-Produkte mit subjektiven Outputs.
...
| 5 | LLM-as-Judge fÃ¼r subjektive Dimensionen hinzufuegen | Woche 3 |
...
**Die Situation:**
- Kein bestehendes Eval-System — QualitÃ¤t wird aktuell per "Team vibes" bewertet
- 3 Anwaelte im Team, die Domain-Expertise haben
- Budget fÃ¼r Eval-Aufbau: 2 Wochen Engineering-Zeit
...
- **Option 2 schafft bleibendes Asset:** Das Golden Dataset dient nicht nur fÃ¼r diesen Modellvergleich — es wird zum Fundament fÃ¼r jede zukuenftige Aenderung (Prompt-Updates, neue Modelle, Feature-Erweiterungen).
...
**Evals sind die wichtigste Kompetenz fÃ¼r AI PMs — weil sie definieren, was "gut" bedeutet, bevor es zu spaet ist.**
...
- Die grÃ¶Ãte PM-Falle: "Wir brauchen zuerst ein Tool." Starte mit manueller Error Analysis. 30 Minuten, 20-50 Outputs. Das zeigt mehr als jedes Dashboard.
