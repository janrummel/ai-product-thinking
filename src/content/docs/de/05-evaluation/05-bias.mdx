...
### Bias-Typen die PMs kennen müssen
...
|---------|--------|----------------|
| 1 | Geschuetzte Attribute für Produkt und Jurisdiktion identifizieren | PM + Legal |
...
| 5 | Red Teaming spezifisch für biased Outputs | PM + Diverse Tester |
...
| 10 | Einspruchsmechanismen für betroffene User bauen | PM + Design |
...
*Quellen: [Buolamwini & Gebru — "Gender Shades"](https://proceedings.mlr.press/v81/buolamwini18a.html) (2018), [Chouldechova — "Fair prediction with disparate impact"](https://arxiv.org/abs/1703.00056) (2017), [Kleinberg et al. — "Inherent Trade-Offs in Algorithmic Fairness"](https://arxiv.org/abs/1609.05807) (2016), EU AI Act (Regulation 2024/1689), NIST AI RMF 1.0, Reuters — Amazon Hiring Tool (2018), Apple Card Investigation (2019)*
