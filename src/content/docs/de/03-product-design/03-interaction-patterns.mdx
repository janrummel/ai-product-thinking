...
- **Human-in-the-Loop:** AI schlÃ¤gt vor, Mensch muss explizit genehmigen bevor etwas passiert. Hoechste Sicherheit, niedrigste Geschwindigkeit. Beispiel: Arzt bestaetigt AI-Diagnose.
- **Human-on-the-Loop:** AI handelt, Mensch ueberwacht und kann eingreifen. Moderater Trade-off. Beispiel: AI kategorisiert Tickets, Team prÃ¼ft Dashboard.
- **Human-out-of-the-Loop:** AI handelt vollstÃ¤ndig autonom. Nur fÃ¼r niedrig-riskante, validierte Tasks. Beispiel: Spam-Filter.
...
- **Expertise-Routing:** AI lernt, welche Menschen fÃ¼r welche Fragen am besten sind
- **Channel-basiert:** Slack/E-Mail/Dashboard je nach Dringlichkeit

### Feedback Loops

Nutzer mÃ¼ssen der AI Feedback geben kÃ¶nnen — aber richtig:

- **Blocking Feedback:** AI pausiert und wartet auf Input. Gut fÃ¼r kritische Entscheidungen.
- **Parallel Feedback:** AI arbeitet weiter, Feedback kommt asynchron. Gut fÃ¼r Volumen-Tasks.

Apple unterscheidet drei Feedback-Typen: *Implizit* (Verhalten), *Explizit* (Daumen hoch/runter), *Korrekturen* (Fehler beheben). Wichtig: Korrekturen sind kein Ersatz fÃ¼r schlechte Ergebnisse. Gefuehrte Korrekturen (Auswahl aus Optionen) schlagen freie Korrekturen (Freitextfeld).
...
**Checkliste fÃ¼r jede AI-Interaktion:**
...
| In | ErklÃ¤rung | "Basierend auf den letzten 5 Tickets" |
| Post | Undo | Ein-Klick-Rueckgaengig |
| Post | Escalation Pathway | "An Mensch uebergeben"-Button |

## Scenario

Du bist PM bei einem B2B-Tool fÃ¼r Vertragsmanagement. Eure AI soll Vertraege automatisch prÃ¼fen und Risiken markieren. 3.000 Vertraege pro Monat, 40% Standard-NDAs, 35% Dienstleistungsvertraege, 25% komplexe individuelle Vertraege.

**Eure Optionen:**
1. **Suggestion-only:** AI markiert Risiken, Jurist prÃ¼ft jeden Vertrag manuell
2. **Gestaffelt:** Standard-NDAs autonom mit Undo, Dienstleistungsvertraege mit Preview, komplexe Vertraege Suggestion-only
3. **Voll autonom:** AI prÃ¼ft alle Vertraege, Juristen prÃ¼fen nur Eskalationen
...
- Investiere in Post-Action: Undo fÃ¼r NDAs, Audit Trail fÃ¼r alles, Escalation Pathway wenn Confidence unter 85%.
...
- **Undo schlÃ¤gt Genehmigung.** FÃ¼r niedrig-riskante, hoch-frequente Tasks ist Undo effizienter als Approval Flows — und Nutzer vertrauen dem System mehr, weil sie die Kontrolle behalten.
