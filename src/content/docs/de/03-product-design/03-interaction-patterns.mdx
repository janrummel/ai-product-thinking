...
- **Human-in-the-Loop:** AI schlaegt vor, Mensch muss explizit genehmigen bevor etwas passiert. Hoechste Sicherheit, niedrigste Geschwindigkeit. Beispiel: Arzt bestaetigt AI-Diagnose.
- **Human-on-the-Loop:** AI handelt, Mensch ueberwacht und kann eingreifen. Moderater Trade-off. Beispiel: AI kategorisiert Tickets, Team prueft Dashboard.
- **Human-out-of-the-Loop:** AI handelt vollstaendig autonom. Nur fuer niedrig-riskante, validierte Tasks. Beispiel: Spam-Filter.
...
- **Expertise-Routing:** AI lernt, welche Menschen fuer welche Fragen am besten sind
- **Channel-basiert:** Slack/E-Mail/Dashboard je nach Dringlichkeit

### Feedback Loops

Nutzer muessen der AI Feedback geben koennen — aber richtig:

- **Blocking Feedback:** AI pausiert und wartet auf Input. Gut fuer kritische Entscheidungen.
- **Parallel Feedback:** AI arbeitet weiter, Feedback kommt asynchron. Gut fuer Volumen-Tasks.

Apple unterscheidet drei Feedback-Typen: *Implizit* (Verhalten), *Explizit* (Daumen hoch/runter), *Korrekturen* (Fehler beheben). Wichtig: Korrekturen sind kein Ersatz fuer schlechte Ergebnisse. Gefuehrte Korrekturen (Auswahl aus Optionen) schlagen freie Korrekturen (Freitextfeld).
...
**Checkliste fuer jede AI-Interaktion:**
...
| In | Erklaerung | "Basierend auf den letzten 5 Tickets" |
| Post | Undo | Ein-Klick-Rueckgaengig |
| Post | Escalation Pathway | "An Mensch uebergeben"-Button |

## Scenario

Du bist PM bei einem B2B-Tool fuer Vertragsmanagement. Eure AI soll Vertraege automatisch pruefen und Risiken markieren. 3.000 Vertraege pro Monat, 40% Standard-NDAs, 35% Dienstleistungsvertraege, 25% komplexe individuelle Vertraege.

**Eure Optionen:**
1. **Suggestion-only:** AI markiert Risiken, Jurist prueft jeden Vertrag manuell
2. **Gestaffelt:** Standard-NDAs autonom mit Undo, Dienstleistungsvertraege mit Preview, komplexe Vertraege Suggestion-only
3. **Voll autonom:** AI prueft alle Vertraege, Juristen pruefen nur Eskalationen
...
- Investiere in Post-Action: Undo fuer NDAs, Audit Trail fuer alles, Escalation Pathway wenn Confidence unter 85%.
...
- **Undo schlaegt Genehmigung.** Fuer niedrig-riskante, hoch-frequente Tasks ist Undo effizienter als Approval Flows — und Nutzer vertrauen dem System mehr, weil sie die Kontrolle behalten.
