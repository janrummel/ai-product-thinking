...
description: "Wie Du generative AI-Features designst, die Erwartungen managen, Edit-Workflows ermoeglichen und Qualitaet sichern — statt User mit unberechenbaren Outputs allein zu lassen."
sidebar:
  order: 4
---
...
Generative Features haben eine einzigartige Herausforderung: Die Qualitaet variiert. Jeder Output ist ein Entwurf, kein Endergebnis. Das erzeugt drei Spannungsfelder:
...
- **Visual Diff** (Notion): Loeschungen grau, Ergaenzungen blau. User sieht sofort was sich aendert
...
- Vary Region fuer partielle Regeneration — nur den Teil aendern, der nicht passt
...
- **Output Guardrails:** Ergebnis pruefen bevor der User es sieht
...
| Guardrails | Wie wird Qualitaet gesichert? | Nur Output-Filter | Input + Output + Fallback UX |
...
**Warum:**
- Das Problem ist nicht die Erstqualitaet (68% Weiterbearbeitung ist solide) — das Problem ist, dass User den Output nicht gezielt anpassen koennen
...
- **Option 3:** Variationen helfen bei der Auswahl, nicht beim Verfeinern. Der Kern-Pain ist "Ich kann nichts gezielt aendern"
</details>
