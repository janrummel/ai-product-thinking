...
description: "Wie Du generative AI-Features designst, die Erwartungen managen, Edit-Workflows ermoeglichen und Qualität sichern — statt User mit unberechenbaren Outputs allein zu lassen."
sidebar:
  order: 4
---
...
Generative Features haben eine einzigartige Herausforderung: Die Qualität variiert. Jeder Output ist ein Entwurf, kein Endergebnis. Das erzeugt drei Spannungsfelder:
...
*Quellen: [Figma AI Report](https://www.figma.com/reports/ai-2025/) (2025), Notion AI UX Patterns (2024), Midjourney UX Documentation (2024), Lenny's Newsletter — User Segmentation for AI (2024), OpenAI Canvas Design Blog (2024)*
