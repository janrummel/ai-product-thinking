---
title: "Wann AI"
description: "Wann AI die richtige LÃ¶sung ist, wann eine einfache Regel reicht — und wie Du die teuersten PM-Fehler vermeidest."
sidebar:
  order: 1
---
...
Dein Stakeholder will einen "AI-powered" Workflow. Dein Engineering-Team kann das bauen. Die Frage, die niemand stellt: Braucht dieses Problem Ã¼berhaupt AI?
...
| Regeln | Endliche If-Then-Ketten | Zu viele Ausnahmen fÃ¼r Regeln |
...
**Wann Rule-Based reicht:** Logik klar und stabil, Entscheidungen mÃ¼ssen auditierbar sein, Prozesse sind wiederholbar.
...
**Die RealitÃ¤t:** Die meisten Enterprise-Probleme sind Hybride. Dein Login-Flow ist deterministisch. Deine Fraud Detection ist probabilistisch. Beides im selben Produkt.

### Die "AI um der AI willen"-Falle

Die Zahlen sind ernuechternd:

- **64% der User** wÃ¼rden Features deaktivieren oder Produkte verlassen, wenn AI-Features aufgezwungen werden (ZDNET/Aberdeen)
...
- **United Healthcare:** 90% Fehlerrate bei einem spezifischen Algorithmus (nH Predict) fÃ¼r Post-Acute-Care-Ablehnungen (STAT News Investigation).
...
| 2 | Verbessert sich das System mit mehr Daten? | Statische LÃ¶sung ist effizienter |
...
Du bist PM bei einem B2B-SaaS fÃ¼r Rechnungsverarbeitung. Der VP Product will "AI-powered Invoice Processing" auf der Roadmap. Aktuell nutzt Ihr Template-basierte OCR mit festen Regeln.

**Die Situation:**
- 120.000 Rechnungen/Monat, 85% folgen 4 Standardformaten
- Aktuelle Rule-Based Accuracy: 94% fÃ¼r Standardformate, 45% fÃ¼r Sonderformate
- AI-Modell im Eval: 96% fÃ¼r Standard, 82% fÃ¼r Sonderformate
...
3. **Hybrid:** Rule-Based fÃ¼r Standardformate, AI nur fÃ¼r Sonderformate
...
- Hybrid-Kosten: ~$660/Monat (Rule-Based fÃ¼r 102k Standard + AI fÃ¼r 18k Sonder) statt $3.600

**Die PM-Fehler in diesem Szenario:**
- **"Bolt-On AI":** AI draufschrauben ohne den Workflow neu zu denken. Rule-Based funktioniert fÃ¼r 85% der Faelle — warum ersetzen?
...
- **AI ist eine LÃ¶sung, kein Feature.** Starte beim Problem, nicht bei der Technologie. Wenn Du nicht erklÃ¤ren kannst welches User-Problem AI loest, hast Du keins.
- **Die meisten Probleme sind Hybride.** Deterministisch wo mÃ¶glich, probabilistisch wo noetig. Das spart Kosten und reduziert Fehler.
