...
- Ist AI die richtige LÃ¶sung? Wende die **5 Check-Fragen** aus Kapitel 1 an.
...
- **Data Quality Plan**: Woher kommen die Daten? Wie sicherst Du QualitÃ¤t?
...
- [ ] Tradeoffs explizit benannt sind (z.B. "wir akzeptieren hoehere Latenz fÃ¼r bessere QualitÃ¤t")
- [ ] Zahlen enthalten sind: Kosten, Metriken-Schwellenwerte, Timelines
- [ ] Mindestens ein Risiko identifiziert ist, das zum Scheitern fuehren kÃ¶nnte
- [ ] Das Dokument fÃ¼r einen nicht-technischen Stakeholder verstÃ¤ndlich ist

## Hinweise

- Es gibt keine "richtige" LÃ¶sung. Es gibt gut durchdachte und schlecht durchdachte Cases.
- Nutze die **Templates** als Startpunkt fÃ¼r einzelne Sektionen.
- Wenn Du in einem Bereich unsicher bist, geh zurÃ¼ck zum entsprechenden Kapitel.
