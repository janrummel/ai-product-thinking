...
**2025-2026 consensus:** LLM-as-Judge has replaced BLEU/ROUGE as the primary quality metric for generative AI. BLEU and ROUGE remain useful as fast, cheap regression checks in CI pipelines.
