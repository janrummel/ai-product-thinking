...
**Jailbreaking:** Techniques to bypass safety guardrails. Early research ([Zou et al., 2023](https://arxiv.org/abs/2307.15043)) showed that jailbreak prompts transfer between models — tests on GPT-4, Claude 2, and Vicuna showed transfer rates of 60-64%. Current models have significantly improved their defenses since, but the principle remains: an attack that works on one model should be tested on all.
...
- Jailbreaks transfer across models ([Zou et al., 2023](https://arxiv.org/abs/2307.15043): 60-64% in early tests). Switching models does not eliminate known vulnerabilities.
