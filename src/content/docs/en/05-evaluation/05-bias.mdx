...
- Disaggregated analysis: Accuracy for applicants with German-sounding names: 91%. Accuracy for applicants with Turkish or Arabic-sounding names: 79%. This disparity disappears in the aggregate metric because the majority group dominates the sample — a classic Simpson's paradox problem.
