...
|------|----------|-------------|
| **[NVIDIA NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails)** | Open-source toolkit | Colang DSL for defining rails; "Adopt" status on [ThoughtWorks Radar](https://www.thoughtworks.com/radar) |
| **[Guardrails AI](https://www.guardrailsai.com/)** | Open-source framework | Validator-based; 100+ pre-built validators |
...
*Sources: [NVIDIA NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) Documentation, [Guardrails AI](https://www.guardrailsai.com/), [ThoughtWorks Technology Radar](https://www.thoughtworks.com/radar), Obsidian Security — AI Guardrails Analysis*
