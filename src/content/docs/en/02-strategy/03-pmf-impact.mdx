...
Reforge identifies four risk areas (scored 1-7 each):
...
**Rule of thumb:** Score 5+ in any area = urgent vulnerability.

### What determines vulnerability

Three factors decide how fast your PMF collapses:

- **Adoption curve position:** The earlier your audience sits on the adoption curve (developers, students), the faster they switch. Stack Overflow lost 50% of traffic in two years — developers left immediately.
...
**Market data:**
- Chegg (education, public data): From $14B to $150M valuation — 99% decline since ChatGPT
- CNET (content, SEO-based): 70% traffic drop
- Stack Overflow (developer Q&A): 50% traffic drop in 2 years
- Counter-example Duolingo (emotional engagement, AI as amplifier): Revenue $748M (+41%), DAUs 40M (+51%)
- AI-native competitors: Cursor $2B ARR, Lovable $200M ARR in under a year, Perplexity $148M ARR
