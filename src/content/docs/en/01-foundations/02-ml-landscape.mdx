...
Andrej Karpathy distinguishes [Software 1.0 from 2.0](https://karpathy.medium.com/software-2-0-a64152b37c35). For PMs, this is the most important foundational distinction:
...
- **[Constitutional AI](https://arxiv.org/abs/2212.08073)** (Anthropic): The model critiques itself against defined principles — scalable without thousands of human raters.
