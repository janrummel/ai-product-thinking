...
**The numbers:** 72% of users say AI *language* impacts perceived trustworthiness. 63% are more likely to rely on AI that shows confidence and reasoning ([NNG](https://www.nngroup.com/), 2024).
...
| Inline next to response | [Google PAIR](https://pair.withgoogle.com/guidebook/): source beside claim | Maximum transparency | Visually complex |
