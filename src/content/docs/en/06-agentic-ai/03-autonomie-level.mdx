...
<img src={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/images/autonomy-levels.svg`} alt="AI Autonomy Levels — L1 Operator to L5 Observer" style="width: 100%; margin: 1.5rem 0;" />
...
*Sources: Knight First Amendment Institute — [Levels of Autonomy for AI Agents (Feng et al., 2025)](https://knightcolumbia.org/content/levels-of-autonomy-for-ai-agents-1), MIT AI Agent Index 2025, Sema4.ai — Five Levels of Agentic Automation (2025)*
